      ...
      <div className={classes.hero}>
        <div className={classes.textContainer}>
          ...
          <p className={classes.subText}>
            ...
            movies, news, and more 24/7, there’s a film for everyone, all the time.
          </p>
          <span onClick={executeScroll} className={classes.scroller}> START YOUR JOURNEY </span>
        </div>
      </div>
      {isLoading ? (
        <div>Loading...</div>
        ...
        <div>
          <h1 ref={myRef} className={classes.subtitle}>Popular Movies</h1>
          <MoviesList
            movies={movies}
